...
export const GAME_CONFIG = {
  ...
  TIME_PER_QUESTION: 8,       // seconds per question (was magic number 8 in GameScreen)
  ACTION_TIME: 5,              // seconds for cashout/revive decision
  LOBBY_COUNTDOWN: 8,          // lobby countdown seconds
  TOTAL_ROUNDS: 10,
  INITIAL_POT: 847000,
  INITIAL_PLAYERS: 1243,
  POT_TICK_MIN: 500,           // min UGX added per pot tick
  POT_TICK_MAX: 2000,          // max UGX added per pot tick
  POT_TICK_INTERVAL: 3000,     // ms between pot ticks
  ELIM_MIN_RATE: 0.35,         // min fraction of players eliminated per round
  ELIM_MAX_RATE: 0.25,         // extra random range on top of min
  MULTIPLIER_BASE: 1,
  MULTIPLIER_PER_ROUND: 0.5,
};
